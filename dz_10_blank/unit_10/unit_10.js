...
let ar2 = [false, 'world', 'javascript', true, 33];
...
let ar3 = [6, 5, 44, 454, 43];

function f3() {
    let divOut = document.querySelector('.out-3');
    divOut.textContent = ar3.length;
}
...
let ar4 = [5, 4, 2, 7, 2, 0, 1, 25, 66, 7, 8, 9];

function f4() {
    let divOut = document.querySelector('.out-4');
    divOut.textContent = `${ar4[0]} ${ar4[3]} ${ar4[8]}`
}
...
function f5() {
    ...
    divOut.textContent = ar5[0] + ar5[2] + ar5[3];
}
...
function f8() {
    ...
    divOut8.textContent = out;
    divOut81.textContent = ar8.length;
...
function f9() {
    ...
    divOut.textContent = ar9[ar9.length-1];
}
...
function f10() {
    ...
    divOut.textContent = ar10[1] + ar10[ar10.length-1];
}
...
function f16() {
    let divOutOdd = document.querySelector('.out-16-odd');
    let divOutEven = document.querySelector('.out-16-even');
    let outOdd = '';
    let outEven = '';
    ...
    divOutOdd.textContent = outOdd;
    divOutEven.textContent = outEven;
}
