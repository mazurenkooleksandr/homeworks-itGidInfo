...
class Goods {
    ...
    draw(setElem) {
        document.querySelector(setElem).innerHTML = `<p>Name: ${this.name} === Amount: ${this.amount} === Count: ${this.count}<br><img src="${this.image}" alt="${this.name}"></p>`
    }
}
...
class Goods2 extends Goods {
    ...
    draw(setElem1) {
        if (this.sale == true) {
            document.querySelector(setElem1).innerHTML = `<p>Name: ${this.name} === Amount: ${this.amount} === Count: ${this.count}<br><img src="${this.image}" alt="${this.name}"></p>` + '<p>Sale!!!</p>';

        } else {
            document.querySelector(setElem1).innerHTML = `<p>Name: ${this.name} === Amount: ${this.amount} === Count: ${this.count}<br><img src="${this.image}" alt="${this.name}"></p>` + ' ';
        }
    }

}

const goods = new Goods('name', 'amount');
const goods2 = new Goods('pumpkin', '40 grn', './img/2.png', '2')
const goods3 = new Goods2('spider', '5000 grn', './img/3.png', '1', true)
console.log(goods);
goods2.draw('.out-4');
goods3.draw('.out-6');
//Task 2.
...
const valid = new Valid('key@gmail.com','12345');
const valid1 = new Valid('key@gmail.com','1234567');
const valid2 = new Valid2('', '12345678');
const valid3 = new Valid2('key@gmail.com', '12345678');
console.log(valid.validate());
console.log(valid1.validate());
