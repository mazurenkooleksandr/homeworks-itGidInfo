...
function f5() {
    ...
    if (divOut4.classList.contains('bg-4')) {
        divOut5.textContent = 'true';
    }
    else {
        divOut5.textContent = 'false';
    }
}
...
function f6() {
    ...
    let allParagraphs = document.querySelectorAll('.p-6');
    
    divOut.textContent = allParagraphs.length;
...
let divOut10 = document.querySelectorAll('.out-10');

for (let i = 0; i < divOut10.length; i++) {
    divOut10[i].onclick = f10;
}
...
function f18() {
    let paragraph18 = document.querySelector('.p-18');
    let attribute = paragraph18.getAttribute('data-b');
    let divOut = document.querySelector('.out-18');

    divOut.textContent = attribute;
}
...
function f19() {
    let paragraph19 = document.querySelectorAll('.p-19');
    let out = '';
    let divOut = document.querySelector('.out-19');

    for (let i = 0; i < paragraph19.length; i++) {
        out += paragraph19[i].getAttribute('data-b') + ' ';
    }

    divOut.textContent = out;
}
