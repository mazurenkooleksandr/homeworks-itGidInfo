...
function t8() {
    let inputValueI81 = document.querySelector('.i-81').value;
    let inputValueI82 = document.querySelector('.i-82').value;
    let num = '';
    let divOut = document.querySelector('.out-8');

    for (let i = inputValueI81; i <= inputValueI82; i++) {
            num += i + ' ';
    }
...
function t9() {
    let inputValueI91 = document.querySelector('.i-91').value;
    let inputValueI92 = document.querySelector('.i-92').value;
    let num = '';
    let divOut = document.querySelector('.out-9');
    let a;
    let b;

    if (inputValueI91 > inputValueI92) {
        a = inputValueI92;
        b = inputValueI91;
    }
    else {
...
function t11() {
    ...
    for (let i = 0; i < allDiv.length; i++) {
        divInfo += allDiv[i].innerHTML + ' ';
    }

    divOut.textContent = divInfo;
}
...
function t13() {
    let inputValue = document.querySelectorAll('.i-13');

    for (let i = 0; i < inputValue.length; i++) {
        inputValue[i].value += i + 1;
    }
}
...
function t14() {
    let inputValue = document.querySelectorAll('.i-14');
    let divOut = document.querySelector('.out-14');

    for (let i = 0; i < inputValue.length; i++) {
        if (inputValue[i].checked) {
            divOut.textContent = inputValue[i].value;
        }
    }
}
