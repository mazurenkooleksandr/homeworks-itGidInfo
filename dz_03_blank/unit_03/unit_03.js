...
function f2(){
    ...
    if (a21 > a22) {
        divOut.textContent = a21;
    }
    else {
        divOut.textContent = a22;
    }
...
function f3(){
    let inputValueI31 = +document.querySelector('.i-31').value;
    let inputValueI32 = +document.querySelector('.i-32').value;
    let divOut = document.querySelector('.out-3');

    if (inputValueI31 > inputValueI32) {
        divOut.textContent = inputValueI31;
    }
    else {
        divOut.textContent = inputValueI32;
    }
}
...
function f6(){
    ...
    if (inputValue % 2) {
        divOut.textContent = 'odd';
    }
    else {
        divOut.textContent = 'even';
    }
}
...
function f7(){
    let inputValueI71 = +document.querySelector('.i-71').value;
    let inputValueI72 = +document.querySelector('.i-72').value;
    let divOut = document.querySelector('.out-7');

    divOut.textContent = Math.pow(inputValueI71, inputValueI72);
}
...
function f8(){
    ...
    switch (selectValue) {
        case '1':
            divOut.textContent = 'one';
            break;
        case '2':
            divOut.textContent = 'two';
            break;
        case '3':
            divOut.textContent = 'three';
            break;
    }
}
...
function f9(){
    ...
    if (inputValue >= 1 && inputValue <= 32) {
        ...
        divOut.textContent = 2;
    } else if (inputValue >= 44 && inputValue <= 64) {
        divOut.textContent = 3;
    }
    else {
        divOut.textContent = 0;
    }
...
function f13(){
    ...
    divOut.innerHTML = (typeof inputValue);
}
...
function f14(){
    let inputValueI141 = +document.querySelector('.i-141').value;
    let inputValueI142 = +document.querySelector('.i-142').value;
    let selectValue = document.querySelector('.s-143').value;
    let divOut = document.querySelector('.out-14');

    switch (selectValue) {
        case '+':
            divOut.textContent = (inputValueI141 + inputValueI142);
            break;
        case '-':
            divOut.textContent = (inputValueI141 - inputValueI142);
            break;
...
function f15(){
    let selectValueS151 = +document.querySelector('.s-151').value;
    let selectValueS152 = +document.querySelector('.s-152').value;
    let selectValueS153 = document.querySelector('.s-153').value;
    let divOut = document.querySelector('.out-15');

    if (selectValueS151 == 1 && selectValueS153 == '&&' && selectValueS152 == 0) {
        divOut.textContent = 0;
    } else if (selectValueS151 == 0 && selectValueS153 == '&&' && selectValueS152 == 1) {
        divOut.textContent = 0;
    } else if (selectValueS151 == 0 && selectValueS153 == '&&' && selectValueS152 == 0) {
        divOut.textContent = 0;
    } else if (selectValueS151 == 1 && selectValueS153 == '&&' && selectValueS152 == 1) {
        divOut.textContent = 1;
    } else if (selectValueS151 == 0 && selectValueS153 == '||' && selectValueS152 == 1) {
        divOut.textContent = 1;
    } else if (selectValueS151 == 1 && selectValueS153 == '||' && selectValueS152 == 1) {
        divOut.textContent = 1;
    } else if (selectValueS151 == 1 && selectValueS153 == '||' && selectValueS152 == 0) {
        divOut.textContent = 1;
    } else if (selectValueS151 == 0 && selectValueS153 == '||' && selectValueS152 == 0) {
        divOut.textContent = 0;
    } 
