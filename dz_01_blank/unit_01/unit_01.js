...
document.querySelector('.three').innerHTML = '<h3>Hello World h3</h3>';
...
document.querySelector('.four').innerHTML += '<h4>Hello World h4</h4>';
document.querySelector('.four').innerHTML += '<p>Hello World p</p>';
