...
function t2() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Oleksandr', true);
    xhttp.send();
}
...
function t3() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=5&num2=6', true);
    xhttp.send();
}
...
function t4() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=1&num2=7', true);
    xhttp.send();
}
...
function t6() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=3&num2=5', true);
    xhttp.send();
...
function t7() {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            m1(this.responseText);
        }
    }
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=7', true);
    xhttp.send();
    function m1(data) {
        document.querySelector('.out-7').innerHTML = `<img src="${data}" width='50px' alt='1'>`;;
    }
...
function t8() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1991', true);
    xhttp.send();
}
...
function t11() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Oleksandr', true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=DdC33D7d2C2a7&action=2&name=Oleksandr');
}
...
function t12() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=2&num2=4', true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=DdC33D7d2C2a7&action=3&num1=2&num2=4');
}
...
function t13() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=3&num2=8', true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=DdC33D7d2C2a7&action=4&num1=3&num2=8');
}
...
function t15() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=2&num2=9', true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send('auth=DdC33D7d2C2a7&action=6&num1=2&num2=9');
}
...
function t17() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1991', true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
